// Build-only module — tools used by `just generate` (tfplugindocs for
// docs/, oapi-codegen for internal/client/openapi/generated.go).
// Kept separate from the provider module so generator deps don't pollute
// the provider's dependency graph.
//
